    ...
    >
      <div className="self-stretch ml-5 mt-11 max-md:max-w-full max-md:mr-1.5 max-md:mt-10">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          <div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0" data-aos="zoom-in-up">
            <img
              loading="lazy"
          ...
          <div className="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0" data-aos="zoom-in-up">
            <img
              loading="lazy"
      ...
      <div className="self-stretch ml-5 mt-14 max-md:max-w-full max-md:mr-1.5 max-md:mt-10">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          <div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0" data-aos="zoom-in-down">
            <img
              loading="lazy"
          ...
          <div className="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0" data-aos="zoom-in-down">
            <img
              loading="lazy"
